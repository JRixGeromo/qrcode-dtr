...
CREATE TABLE `tbl_employee` (
  ...
  `qr_url` int(11) NOT NULL,
  `carr_id` int(11) NOT NULL,
  PRIMARY KEY (`emp_id`),
  KEY `carr_id` (`carr_id`),
  CONSTRAINT `tbl_employee_ibfk_1` FOREIGN KEY (`carr_id`) REFERENCES `tbl_carrera` (`carr_id`)
...
INSERT INTO `tbl_employee` VALUES (4,'Esteban','LEON',19201202,2),(7,'Carlos','Gonzalez',123456,3);
